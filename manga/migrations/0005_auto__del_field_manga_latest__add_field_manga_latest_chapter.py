...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'manga_manga', 'latest_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'manga_manga', 'latest',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['manga.NewChapter']),
                      keep_default=False)
    ...
    models = {
        u'manga.manga': {
            ...
            'latest_chapter': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': u"orm['manga.NewChapter']"}),
